...
function updateSite(id, fields) {
  ...
  if (!site) return null;
  ['store_name', 'description', 'description_align', 'description_size', 'description_font', 'background_url', 'background_type', 'payment_link', 'published', 'theme', 'cartPosition'].forEach(f => {
