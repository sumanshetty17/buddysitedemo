...
// a "Shop by Category" tile grid, admin-curated titled Category Sections
// (e.g. "Top Deals"), a "Shop All" product grid with a sticky filter bar,
// and a brand-story + socials footer.
