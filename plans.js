...
const PLANS = {
  ...
  growth: {
    ...
    watermark: false,
    blurb: 'Organize products into categories, remove branding, add video backgrounds.'
  },
  pro: {
    key: 'pro',
    name: 'Pro',
    ...
    videoBackgrounds: true,
    watermark: false,
    blurb: 'The full toolkit — unlimited categories, multiple stores, video backgrounds.'
  }
};
